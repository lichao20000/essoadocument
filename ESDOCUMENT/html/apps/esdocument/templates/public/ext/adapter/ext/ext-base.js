 ...
 * 
 * 
 * liukaiyuan 20091013 fix the memory bug
 */
...
(function() {
	...
	var isStrict = document.compatMode == "CSS1Compat", isOpera = ua
			...
			&& ua.indexOf("msie 8") > -1,isIE9 = !isOpera
			&& ua.indexOf("msie 9") > -1,isChrome = !isOpera
			&& ua.indexOf("chrome") > -1,isGecko = !isSafari&&!isChrome
	...
	Ext.apply(Ext, {
		...
		BLANK_IMAGE_URL : "/apps/esdocument/templates/public/ext/source/s.gif",
		emptyFn : function() {
		},
