...
//本方法为jquery的notice方法，由于现在消息框改为4.0的样式，将原来的方法改个名
artDialog.noticeOld = function (options) {
	var opt = options || {},
...
//右下角弹窗
//liqiubo 20140922 改为4.0的方式显示小时，如果想用原来的方法，请使用noticeOld方法
artDialog.notice = function (options) {
	...
	var cWidth = document.documentElement.clientWidth || document.body.clientWidth;
	 ...
	 if('succeed' == options.icon || 'success' == options.icon){//成功
//	 	document.getElementById('messageUIImg').src = '/templates/es/messageUI/images/success.png';
	 	document.getElementById('messageUIImg').src =   artDialog.defaults.path+'/images/success.png';
	 }else if('error' == options.icon){//失败
	 	document.getElementById('messageUIImg').src =  artDialog.defaults.path+'/images/failure.png';
	 }else if('warning' == options.icon){//警告
	 	document.getElementById('messageUIImg').src = artDialog.defaults.path+'/images/warning.png';
	 }
...
function preMsgShowMouseOver(){
	document.getElementById('preMsgShowDiv').style.background = "url('"+artDialog.defaults.path+"/images/showPreMsgMouseOver.png')";
}

function preMsgShowMouseOut(){
	document.getElementById('preMsgShowDiv').style.background = "url('"+artDialog.defaults.path+"/images/showPreMsg.png')";
}
