...
$('#bigblogMap area').on('click',function() {
	...
	var url='<img src=/apps/esdocument/templates/ESDiscuss/img/miniblog/'+name+'.gif >';
	var id = $('input[name="commentid"]').val();
...
$('#bigblogMap area').hover(
	function() {
		...
		var imgUrl = '/apps/esdocument/templates/ESDiscuss/img/miniblog/'+imgName+'.gif';
	...
	$.ajax({
		...
		success:function(data){
			if(data.result=='succeed'){
				...
				var rep='<img src=/apps/esdocument/templates/ESDiscuss/img/miniblog/$1.gif >';
				var con=content.replace(/\[([a-zA-Z]+?)\]/g,rep);
				temp = null;
				var msg="<ul class='messages'>";
					msg+="<li class='face'>";
					msg+="<a href='javascript:;'>";
					msg+="<img src='/apps/esdocument/templates/ESDiscuss/img/logo.png' title='' alt='头像' /></a>";
					msg+="</li>";
