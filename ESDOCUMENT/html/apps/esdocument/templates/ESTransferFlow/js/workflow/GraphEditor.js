...
//    Ext.QuickTips.init();
    ...
    var node = mxUtils.load(tplPath+'/ESTransferFlow/js/workflow/resources/default-style.xml').getDocumentElement();
...
//    graph.setTooltips(true);//jiang note20100116
    	...
    	var cell=graph.getSelectionCell();
      	if(cell){
			...
			if(thisSstyle!=null&&thisSstyle.length>=7&&thisSstyle.substring(0,7)=='ellipse'&&thisIsEdge==false&&(thisCellValue=='开始'||thisCellValue=='结束')){
	    		...
	    		toolbarItems.get('paste').setDisabled(mxClipboard.isEmpty());
	        }else{
   ...
   insertVertexTemplate(library, graph, '节点', tplPath+'/ESTransferFlow/js/workflow/images/rectangle.gif', 'rounded=1;fontColor=#000000', 100, 40,'审批步骤');
//   insertVertexTemplate(library, graph, '节点', tplPath+'/ESTransferFlow/js/workflow/images/rectangle.gif', 'rounded=1', 100, 40);
  //  insertVertexTemplate(library, graph,'开始', tplPath+'/ESTransferFlow/js/workflow/images/ellipse.gif', 'ellipse;fillColor=#FF0000;fontColor=#000000', 100, 40,'开始');
//	insertVertexTemplate(library, graph, '结束', tplPath+'/ESTransferFlow/js/workflow/images/ellipse.gif', 'ellipse;strokeColor=#99CC00;fillColor=#99CC00;fontColor=#000000', 100, 40,'结束');
    insertVertexTemplate(library, graph, '分支',tplPath+'/ESTransferFlow/js/workflow/images/rhombus.gif', 'rhombus;fontColor=#000000', 100, 40,'分支');
    insertVertexTemplate(library, graph, '聚合',tplPath+'/ESTransferFlow/js/workflow/images/rhombus.gif', 'rhombus;fontColor=#000000', 100, 40,'聚合');
    insertEdgeTemplate(library, graph, '直线', tplPath+'/ESTransferFlow/js/workflow/images/straight.gif', 'straight', 100, 100,'同意');
	insertEdgeTemplate(library, graph, '曲线', tplPath+'/ESTransferFlow/js/workflow/images/connect.gif', '', 100, 100,'同意');
//    insertVertexTemplate(library, graph, 'Triangle', tplPath+'/ESTransferFlow/js/workflow/images/triangle.gif', 'triangle', 40, 60);
//    insertVertexTemplate(library, graph, 'Container', tplPath+'/ESTransferFlow/js/workflow/images/swimlane.gif', 'swimlane', 200, 200, 'Container');
//    insertVertexTemplate(library, graph, 'Double Ellipse', tplPath+'/ESTransferFlow/js/workflow/images/doubleellipse.gif', 'ellipse;shape=doubleEllipse', 60, 60);
//    
//	insertVertexTemplate(library, graph, 'Horizontal Line', tplPath+'/ESTransferFlow/js/workflow/images/hline.gif', 'line', 120, 10);
//    insertVertexTemplate(library, graph, 'Hexagon', tplPath+'/ESTransferFlow/js/workflow/images/hexagon.gif', 'shape=hexagon', 80, 60);
//    insertVertexTemplate(library, graph, 'Cylinder', tplPath+'/ESTransferFlow/js/workflow/images/cylinder.gif', 'shape=cylinder', 60, 80);
//    insertVertexTemplate(library, graph, 'Actor', tplPath+'/ESTransferFlow/js/workflow/images/actor.gif', 'shape=actor', 40, 60);
//    insertVertexTemplate(library, graph, 'Cloud', tplPath+'/ESTransferFlow/js/workflow/images/cloud.gif', 'ellipse;shape=cloud', 80, 60);
...
//      insertImageTemplate(library, graph,'用户',tplPath+'/ESTransferFlow/js/workflow/images/dude3.png', true);
//	  insertImageTemplate(library, graph, 'Message', tplPath+'/ESTransferFlow/js/workflow/images/symbols/message.png', true);
...
//	insertEdgeTemplate(library, graph, 'Arrow', 'images/arrow.gif', 'arrow', 100, 100);
    ...
    keyHandler.bindKey(46, function()//删除
    {
    	//------------------------------------------
...
//						graph.removeCells();
    ...
    keyHandler.bindControlKey(88, function()//剪切
    {
    ...
    keyHandler.bindControlKey(67, function()//复制
    {
